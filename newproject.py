...
name_font = ImageFont.truetype('bahnschrift.ttf', size=72)
name2_font=ImageFont.truetype('AutumnFlowers-9YVZK.ttf', size=80)
watermark_font = ImageFont.truetype('arial.ttf',size=24)
name1='Fact About Yourself'
...
ImageDraw.Draw(image).text((40,40),str(name1),fill='rgb(0,0,0)',font=name2_font)
ImageDraw.Draw(image).text((70,180),str(name),fill='rgb(0,0,0)',font=name_font)
ImageDraw.Draw(image).text((1000-800,1000-80),'*** CREATED BY GITAMW STUDENTS***',fill='rgb(0,0,0)',font=watermark_font)
